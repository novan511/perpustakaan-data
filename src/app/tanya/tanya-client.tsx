...
interface TanyaClientProps {
  qaItems: QAItemRow[];
  categories: Array<{ name: string; count: number }>;
  totalItems: number;
}

export default function TanyaClient({ qaItems, categories, totalItems }: TanyaClientProps) {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <span className="text-[10px] bg-blue-50 dark:bg-blue-900/20 px-2 py-0.5 rounded text-blue-600 dark:text-blue-400">{qa.data_points.length} data points</span>
                    </div>
                  </div>
                </div>
              </Link>
