...
import { bpsKPIs, biKPIs, kemendagKPIs, lpsKPIs, ojkKPIs, kemenkeuKPIs } from "@/lib/data";

const sectors = [
  { id: "statistik", name: "BPS - Badan Pusat Statistik", description: "PDB, inflasi, kemiskinan, pengangguran, populasi", href: "/sektor/statistik", kpis: bpsKPIs.slice(0, 2) },
  { id: "moneter", name: "Bank Indonesia", description: "BI-Rate, kurs JISDOR, cadangan devisa", href: "/sektor/moneter", kpis: biKPIs.slice(0, 2) },
  { id: "perdagangan", name: "Kementerian Perdagangan", description: "Ekspor, impor, neraca perdagangan", href: "/sektor/perdagangan", kpis: kemendagKPIs.slice(0, 2) },
  { id: "simpanan", name: "LPS - Lembaga Penjamin Simpanan", description: "Bunga penjaminan, distribusi simpanan", href: "/sektor/simpanan", kpis: lpsKPIs.slice(0, 2) },
  { id: "perbankan", name: "OJK - Otoritas Jasa Keuangan", description: "Aset perbankan, NPL, pertumbuhan kredit", href: "/sektor/perbankan", kpis: ojkKPIs.slice(0, 2) },
  { id: "fiskal", name: "Kementerian Keuangan", description: "APBN, penerimaan, belanja negara", href: "/sektor/fiskal", kpis: kemenkeuKPIs.slice(0, 2) },
];
